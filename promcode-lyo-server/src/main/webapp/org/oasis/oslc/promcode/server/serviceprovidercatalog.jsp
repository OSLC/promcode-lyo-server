...
<html lang="en">
  <head>
    ...
    <title>Service Provider Catalog - PROMCODE Server OSLC Adapter</title>
  ...
  <div class="container">
    <div class="page-header">
      <h1>PROMCODE Server Service Provider Catalogue</h1>
    </div>
    ...
    <% if (catalog.getServiceProviders().length == 0) {%>
        <div class="alert alert-primary" role="alert">
            ...
            <p>
                ...
                in the class <code>org.oasis.oslc.promcode.server.RestDelegate</code>, to return the expected set of Service Provider resources.
            </p>
        </div>
    <% } %>
