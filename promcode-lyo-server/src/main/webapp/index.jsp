...
<div class="container">
    <div class="jumbotron">
        ...
        <p class="lead">This is a homepage of the <em>PROMCODE Server</em> that was generated using
        ...
        <p>The OSLC Root Services document is available at <code><%= UriBuilder.fromUri(OSLC4JUtils.getServletURI()).path("/rootservices").build() %></code></p>
    </div>
</div>
</body>
</html>
