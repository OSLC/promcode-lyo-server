...
public class ProjectService
{
    ...
    @Operation(
        summary = "GET for resources of type {'" + Oslc_promcodeDomainConstants.PROJECT_LOCALNAME + "'}",
        description = "GET for resources of type {'" + "<a href=\"" + Oslc_promcodeDomainConstants.PROJECT_TYPE + "\">" + Oslc_promcodeDomainConstants.PROJECT_LOCALNAME + "</a>" + "'}" +
