...
public class ServiceProviderService1
{
    ...
    (
         ...
         uri = "service1/artifacts/selector",
         hintWidth = "750px",
         hintHeight = "750px",
         resourceTypes = {Oslc_promcodeDomainConstants.ARTIFACT_TYPE},
         usages = {}
    )
    @GET
    @Path("selector")
    @Consumes({ MediaType.TEXT_HTML, MediaType.WILDCARD })
    public Response ArtifactSelector(
        @QueryParam("terms") final String terms
        
        ) throws ServletException, IOException, JSONException
    {
        // Start of user code ArtifactSelector_init
        // End of user code
        ...
        // Start of user code ArtifactSelector_setAttributes
        if (terms != null) {
            try {
                ...
                if ("true".equalsIgnoreCase(httpServletRequest.getHeader("HX-Request"))) {
                    ...
                    RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslc/promcode/server/artifactselector-results.jsp");
        ...
        if (terms != null) {
            ...
            final List<Artifact> resources = delegate.ArtifactSelector(httpServletRequest, terms);
            if (resources != null) {
                if ("true".equalsIgnoreCase(httpServletRequest.getHeader("HX-Request"))) {
                    ...
                    for (Artifact resource : resources) {
                        ...
                        // Start of user code ArtifactSelector_setResponse
            ...
            httpServletRequest.setAttribute("resourceTypeLabel", "Artifact");
            httpServletRequest.setAttribute("fieldsToList", "[\"Label\"]");
            // Start of user code ArtifactSelector_setAttribute_fieldsToList
            //TODO: set the attribute "fieldsToList" to form the list of properties you want displayed in the search result
            // End of user code
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslc/promcode/server/artifactselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return null;
        }
    }
    ...
    /**
     * Create a single Artifact via RDF/XML, XML or JSON POST
     *
     * @throws IOException
    ...
    (
         ...
         resourceShapes = {OslcConstants.PATH_RESOURCE_SHAPES + "/" + Oslc_promcodeDomainConstants.ARTIFACT_PATH},
         resourceTypes = {Oslc_promcodeDomainConstants.ARTIFACT_TYPE},
         usages = {}
    )
    @POST
    ...
    @Operation(
        summary = "Creation factory for resources of type {" + Oslc_promcodeDomainConstants.ARTIFACT_LOCALNAME + "}",
        description = "Creation factory for resources of type {" + "<a href=\"" + Oslc_promcodeDomainConstants.ARTIFACT_TYPE + "\">" + Oslc_promcodeDomainConstants.ARTIFACT_LOCALNAME + "</a>" + "}" +
    ...
    public Response createArtifact(
            ...
            final Artifact aResource
        ) throws IOException, ServletException
    {
        Artifact newResource = delegate.createArtifact(httpServletRequest, aResource);
        httpServletResponse.setHeader("ETag", delegate.getETagFromArtifact(newResource));
