        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aArtifact != null) {
            ...
            try {
                ...
                ArrayList<String> getterMethodNames = new ArrayList<String>(Arrays.asList("getDescription", "getIdentifier", "getIsPartOf", "getSource", "getTitle", "getProducedFor", "getSequenceNumber", "getTargets"));
